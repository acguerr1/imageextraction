            ...
            try:
                ...
                for page_num, image in enumerate(images):
                    try:
                        ...
                        if detect_barcodes(border_removed_image):
                            print(f"Barcode detected on page {page_num + 1} of file {filename}. Skipping detection.")
                            continue
                        ...
                        for x1, y1, x2, y2 in merged_boxes:
                            ...
                            if aspect_ratio <= 6 and (1/aspect_ratio) <= 6 and area >= 20000:
...
def process_pdfs_in_batches(input_dir, output_dir, batch_size=5, threshold=0, debug=False):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--threshold", type=float, default=0, help="Confidence threshold for YOLO model.")

    args = parser.parse_args()
    process_pdfs_in_batches(args.input_dir, args.output_dir, batch_size=args.batch_size, threshold=args.threshold, debug=args.debug)
